...
const arr = {//object of certificates
    "accenture": '<img src="certificates/accenture.png" alt="">',
    "aws": '<img src="certificates/AWS.png" alt="">',
    "CodingNinja1": '<img src="certificates/CodingNinja1.png" alt="">',
    "CodingNinja2": '<img src="certificates/CodingNinja2.png" alt="">',
    "GoldMans": '<img src="certificates/GoldMans.png" alt="">'
};
...
function changeFun(checker) {//checker variable use for moving button i.e arrow button
    ...
    if (i == 1)
        CerContent.innerHTML = arr.aws;
    else if (i == 2)
        CerContent.innerHTML = arr.accenture;
    else if (i == 3)
        CerContent.innerHTML = arr.CodingNinja1;
    else if (i == 4)
        CerContent.innerHTML = arr.CodingNinja2;
    else if (i == 5)
        CerContent.innerHTML = arr.GoldMans;
    if (i == 5)
        i = 0;
    else if (i <= 0)
        i = 5;
